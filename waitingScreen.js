...
import Billy from './src/image/pngegg.png'
import { socket } from './App.js'
import { useState } from "react"
import { Redirect } from 'react-router-dom'
import styles from './src/WaitingScreen/waitingScreen.module.css'
import BloodyPhrase from './src/image/bloodyPhrase.png'
import Snackbar from '@material-ui/core/Snackbar'
import MuiAlert from '@material-ui/lab/Alert'
import BillySound from './src/sound/I  Want to play a game.mp3'
    ...
    return (
        <Container maxWidth="sm" className={styles.container} >
            ...
            <div className={styles.linkBlock}>
                <p id="copyText" className={styles.copyText}>{"http://localhost:3000/id/" + props.socketId}</p>
